...
namespace BedAndBreakfast
{
    public partial class BreakfastOptionForm : Form
    {
        ...
        //ignore buttons that are not radio buttons
        ...
        private void contBreakfastButton_Click(object sender, EventArgs e)
        {
            
        }

        private void fullBreakfastButton_Click(object sender, EventArgs e)
        {
            
        }

        private void deluxeBreakfastButton_Click(object sender, EventArgs e)
        {
